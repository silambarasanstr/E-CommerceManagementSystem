...
const Products: React.FC = () => {
  ...
  if (!product) return <EmptyState message="No products found." />;
          ...
          <div className="p-6 bg-white rounded">
            ...
            <div className="mb-5">
              <div className="flex items-center gap-3">
                ...
                <span className="font-semibold text-green-600">30% off</span>
              </div>
            </div>
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>🎉 Special Price - Get extra discount on this item</li>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center border rounded w-fit">
                ...
                <span className="text-center w-14">{quantity}</span>
